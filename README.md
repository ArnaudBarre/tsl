...
> [!IMPORTANT]
> The list of files is only files that where linted. If you need a generated file to in that list, but still want to ignore all lint rules inside it, use a top level ignore comment instead of using the ignore option.
