...
export type Visitor<Data = undefined> = {
  ...
  "AnyKeyword:exit"?(node: AnyKeyword, context: Context<Data>): void;
  ArrayBindingPattern?(node: ArrayBindingPattern, context: Context<Data>): void;
  "ArrayBindingPattern:exit"?(node: ArrayBindingPattern, context: Context<Data>): void;
  ArrayLiteralExpression?(node: ArrayLiteralExpression, context: Context<Data>): void;
  "ArrayLiteralExpression:exit"?(node: ArrayLiteralExpression, context: Context<Data>): void;
  ArrayType?(node: ArrayTypeNode, context: Context<Data>): void;
  "ArrayType:exit"?(node: ArrayTypeNode, context: Context<Data>): void;
  ArrowFunction?(node: ArrowFunction, context: Context<Data>): void;
  "ArrowFunction:exit"?(node: ArrowFunction, context: Context<Data>): void;
  AsExpression?(node: AsExpression, context: Context<Data>): void;
  "AsExpression:exit"?(node: AsExpression, context: Context<Data>): void;
  AwaitExpression?(node: AwaitExpression, context: Context<Data>): void;
  "AwaitExpression:exit"?(node: AwaitExpression, context: Context<Data>): void;
  BigIntKeyword?(node: BigIntKeyword, context: Context<Data>): void;
  "BigIntKeyword:exit"?(node: BigIntKeyword, context: Context<Data>): void;
  BigIntLiteral?(node: BigIntLiteral, context: Context<Data>): void;
  "BigIntLiteral:exit"?(node: BigIntLiteral, context: Context<Data>): void;
  BinaryExpression?(node: BinaryExpression, context: Context<Data>): void;
  "BinaryExpression:exit"?(node: BinaryExpression, context: Context<Data>): void;
  BindingElement?(node: BindingElement, context: Context<Data>): void;
  "BindingElement:exit"?(node: BindingElement, context: Context<Data>): void;
  Block?(node: Block, context: Context<Data>): void;
  "Block:exit"?(node: Block, context: Context<Data>): void;
  BooleanKeyword?(node: BooleanKeyword, context: Context<Data>): void;
  "BooleanKeyword:exit"?(node: BooleanKeyword, context: Context<Data>): void;
  BreakStatement?(node: BreakStatement, context: Context<Data>): void;
  "BreakStatement:exit"?(node: BreakStatement, context: Context<Data>): void;
  CallExpression?(node: CallExpression, context: Context<Data>): void;
  "CallExpression:exit"?(node: CallExpression, context: Context<Data>): void;
  CallSignature?(node: CallSignatureDeclaration, context: Context<Data>): void;
  "CallSignature:exit"?(node: CallSignatureDeclaration, context: Context<Data>): void;
  CaseBlock?(node: CaseBlock, context: Context<Data>): void;
  "CaseBlock:exit"?(node: CaseBlock, context: Context<Data>): void;
  CaseClause?(node: CaseClause, context: Context<Data>): void;
  "CaseClause:exit"?(node: CaseClause, context: Context<Data>): void;
  CatchClause?(node: CatchClause, context: Context<Data>): void;
  "CatchClause:exit"?(node: CatchClause, context: Context<Data>): void;
  ClassDeclaration?(node: ClassDeclaration, context: Context<Data>): void;
  "ClassDeclaration:exit"?(node: ClassDeclaration, context: Context<Data>): void;
  ClassExpression?(node: ClassExpression, context: Context<Data>): void;
  "ClassExpression:exit"?(node: ClassExpression, context: Context<Data>): void;
  ClassStaticBlockDeclaration?(node: ClassStaticBlockDeclaration, context: Context<Data>): void;
  "ClassStaticBlockDeclaration:exit"?(node: ClassStaticBlockDeclaration, context: Context<Data>): void;
  CommaListExpression?(node: CommaListExpression, context: Context<Data>): void;
  "CommaListExpression:exit"?(node: CommaListExpression, context: Context<Data>): void;
  ComputedPropertyName?(node: ComputedPropertyName, context: Context<Data>): void;
  "ComputedPropertyName:exit"?(node: ComputedPropertyName, context: Context<Data>): void;
  ConditionalExpression?(node: ConditionalExpression, context: Context<Data>): void;
  "ConditionalExpression:exit"?(node: ConditionalExpression, context: Context<Data>): void;
  ConditionalType?(node: ConditionalTypeNode, context: Context<Data>): void;
  "ConditionalType:exit"?(node: ConditionalTypeNode, context: Context<Data>): void;
  ConstructSignature?(node: ConstructSignatureDeclaration, context: Context<Data>): void;
  "ConstructSignature:exit"?(node: ConstructSignatureDeclaration, context: Context<Data>): void;
  Constructor?(node: ConstructorDeclaration, context: Context<Data>): void;
  "Constructor:exit"?(node: ConstructorDeclaration, context: Context<Data>): void;
  ConstructorType?(node: ConstructorTypeNode, context: Context<Data>): void;
  "ConstructorType:exit"?(node: ConstructorTypeNode, context: Context<Data>): void;
  ContinueStatement?(node: ContinueStatement, context: Context<Data>): void;
  "ContinueStatement:exit"?(node: ContinueStatement, context: Context<Data>): void;
  DebuggerStatement?(node: DebuggerStatement, context: Context<Data>): void;
  "DebuggerStatement:exit"?(node: DebuggerStatement, context: Context<Data>): void;
  Decorator?(node: Decorator, context: Context<Data>): void;
  "Decorator:exit"?(node: Decorator, context: Context<Data>): void;
  DefaultClause?(node: DefaultClause, context: Context<Data>): void;
  "DefaultClause:exit"?(node: DefaultClause, context: Context<Data>): void;
  DeleteExpression?(node: DeleteExpression, context: Context<Data>): void;
  "DeleteExpression:exit"?(node: DeleteExpression, context: Context<Data>): void;
  DoStatement?(node: DoStatement, context: Context<Data>): void;
  "DoStatement:exit"?(node: DoStatement, context: Context<Data>): void;
  ElementAccessExpression?(node: ElementAccessExpression, context: Context<Data>): void;
  "ElementAccessExpression:exit"?(node: ElementAccessExpression, context: Context<Data>): void;
  EmptyStatement?(node: EmptyStatement, context: Context<Data>): void;
  "EmptyStatement:exit"?(node: EmptyStatement, context: Context<Data>): void;
  EnumDeclaration?(node: EnumDeclaration, context: Context<Data>): void;
  "EnumDeclaration:exit"?(node: EnumDeclaration, context: Context<Data>): void;
  EnumMember?(node: EnumMember, context: Context<Data>): void;
  "EnumMember:exit"?(node: EnumMember, context: Context<Data>): void;
  ExportAssignment?(node: ExportAssignment, context: Context<Data>): void;
  "ExportAssignment:exit"?(node: ExportAssignment, context: Context<Data>): void;
  ExportDeclaration?(node: ExportDeclaration, context: Context<Data>): void;
  "ExportDeclaration:exit"?(node: ExportDeclaration, context: Context<Data>): void;
  ExportSpecifier?(node: ExportSpecifier, context: Context<Data>): void;
  "ExportSpecifier:exit"?(node: ExportSpecifier, context: Context<Data>): void;
  ExpressionStatement?(node: ExpressionStatement, context: Context<Data>): void;
  "ExpressionStatement:exit"?(node: ExpressionStatement, context: Context<Data>): void;
  ExpressionWithTypeArguments?(node: ExpressionWithTypeArguments, context: Context<Data>): void;
  "ExpressionWithTypeArguments:exit"?(node: ExpressionWithTypeArguments, context: Context<Data>): void;
  ExternalModuleReference?(node: ExternalModuleReference, context: Context<Data>): void;
  "ExternalModuleReference:exit"?(node: ExternalModuleReference, context: Context<Data>): void;
  FalseKeyword?(node: FalseLiteral, context: Context<Data>): void;
  "FalseKeyword:exit"?(node: FalseLiteral, context: Context<Data>): void;
  ForInStatement?(node: ForInStatement, context: Context<Data>): void;
  "ForInStatement:exit"?(node: ForInStatement, context: Context<Data>): void;
  ForOfStatement?(node: ForOfStatement, context: Context<Data>): void;
  "ForOfStatement:exit"?(node: ForOfStatement, context: Context<Data>): void;
  ForStatement?(node: ForStatement, context: Context<Data>): void;
  "ForStatement:exit"?(node: ForStatement, context: Context<Data>): void;
  FunctionDeclaration?(node: FunctionDeclaration, context: Context<Data>): void;
  "FunctionDeclaration:exit"?(node: FunctionDeclaration, context: Context<Data>): void;
  FunctionExpression?(node: FunctionExpression, context: Context<Data>): void;
  "FunctionExpression:exit"?(node: FunctionExpression, context: Context<Data>): void;
  FunctionType?(node: FunctionTypeNode, context: Context<Data>): void;
  "FunctionType:exit"?(node: FunctionTypeNode, context: Context<Data>): void;
  GetAccessor?(node: GetAccessorDeclaration, context: Context<Data>): void;
  "GetAccessor:exit"?(node: GetAccessorDeclaration, context: Context<Data>): void;
  HeritageClause?(node: HeritageClause, context: Context<Data>): void;
  "HeritageClause:exit"?(node: HeritageClause, context: Context<Data>): void;
  Identifier?(node: Identifier, context: Context<Data>): void;
  "Identifier:exit"?(node: Identifier, context: Context<Data>): void;
  IfStatement?(node: IfStatement, context: Context<Data>): void;
  "IfStatement:exit"?(node: IfStatement, context: Context<Data>): void;
  ImportAttribute?(node: ImportAttribute, context: Context<Data>): void;
  "ImportAttribute:exit"?(node: ImportAttribute, context: Context<Data>): void;
  ImportAttributes?(node: ImportAttributes, context: Context<Data>): void;
  "ImportAttributes:exit"?(node: ImportAttributes, context: Context<Data>): void;
  ImportClause?(node: ImportClause, context: Context<Data>): void;
  "ImportClause:exit"?(node: ImportClause, context: Context<Data>): void;
  ImportDeclaration?(node: ImportDeclaration, context: Context<Data>): void;
  "ImportDeclaration:exit"?(node: ImportDeclaration, context: Context<Data>): void;
  ImportEqualsDeclaration?(node: ImportEqualsDeclaration, context: Context<Data>): void;
  "ImportEqualsDeclaration:exit"?(node: ImportEqualsDeclaration, context: Context<Data>): void;
  ImportKeyword?(node: ImportExpression, context: Context<Data>): void;
  "ImportKeyword:exit"?(node: ImportExpression, context: Context<Data>): void;
  ImportSpecifier?(node: ImportSpecifier, context: Context<Data>): void;
  "ImportSpecifier:exit"?(node: ImportSpecifier, context: Context<Data>): void;
  ImportType?(node: ImportTypeNode, context: Context<Data>): void;
  "ImportType:exit"?(node: ImportTypeNode, context: Context<Data>): void;
  IndexSignature?(node: IndexSignatureDeclaration, context: Context<Data>): void;
  "IndexSignature:exit"?(node: IndexSignatureDeclaration, context: Context<Data>): void;
  IndexedAccessType?(node: IndexedAccessTypeNode, context: Context<Data>): void;
  "IndexedAccessType:exit"?(node: IndexedAccessTypeNode, context: Context<Data>): void;
  InferType?(node: InferTypeNode, context: Context<Data>): void;
  "InferType:exit"?(node: InferTypeNode, context: Context<Data>): void;
  InterfaceDeclaration?(node: InterfaceDeclaration, context: Context<Data>): void;
  "InterfaceDeclaration:exit"?(node: InterfaceDeclaration, context: Context<Data>): void;
  IntersectionType?(node: IntersectionTypeNode, context: Context<Data>): void;
  "IntersectionType:exit"?(node: IntersectionTypeNode, context: Context<Data>): void;
  IntrinsicKeyword?(node: IntrinsicKeyword, context: Context<Data>): void;
  "IntrinsicKeyword:exit"?(node: IntrinsicKeyword, context: Context<Data>): void;
  JSDocAllType?(node: JSDocAllType, context: Context<Data>): void;
  "JSDocAllType:exit"?(node: JSDocAllType, context: Context<Data>): void;
  JSDocFunctionType?(node: JSDocFunctionType, context: Context<Data>): void;
  "JSDocFunctionType:exit"?(node: JSDocFunctionType, context: Context<Data>): void;
  JSDocLink?(node: JSDocLink, context: Context<Data>): void;
  "JSDocLink:exit"?(node: JSDocLink, context: Context<Data>): void;
  JSDocLinkCode?(node: JSDocLinkCode, context: Context<Data>): void;
  "JSDocLinkCode:exit"?(node: JSDocLinkCode, context: Context<Data>): void;
  JSDocLinkPlain?(node: JSDocLinkPlain, context: Context<Data>): void;
  "JSDocLinkPlain:exit"?(node: JSDocLinkPlain, context: Context<Data>): void;
  JSDocMemberName?(node: JSDocMemberName, context: Context<Data>): void;
  "JSDocMemberName:exit"?(node: JSDocMemberName, context: Context<Data>): void;
  JSDocNamepathType?(node: JSDocNamepathType, context: Context<Data>): void;
  "JSDocNamepathType:exit"?(node: JSDocNamepathType, context: Context<Data>): void;
  JSDocNonNullableType?(node: JSDocNonNullableType, context: Context<Data>): void;
  "JSDocNonNullableType:exit"?(node: JSDocNonNullableType, context: Context<Data>): void;
  JSDocNullableType?(node: JSDocNullableType, context: Context<Data>): void;
  "JSDocNullableType:exit"?(node: JSDocNullableType, context: Context<Data>): void;
  JSDocOptionalType?(node: JSDocOptionalType, context: Context<Data>): void;
  "JSDocOptionalType:exit"?(node: JSDocOptionalType, context: Context<Data>): void;
  JSDocParameterTag?(node: JSDocParameterTag, context: Context<Data>): void;
  "JSDocParameterTag:exit"?(node: JSDocParameterTag, context: Context<Data>): void;
  JSDocPropertyTag?(node: JSDocPropertyTag, context: Context<Data>): void;
  "JSDocPropertyTag:exit"?(node: JSDocPropertyTag, context: Context<Data>): void;
  JSDocReturnTag?(node: JSDocReturnTag, context: Context<Data>): void;
  "JSDocReturnTag:exit"?(node: JSDocReturnTag, context: Context<Data>): void;
  JSDocSignature?(node: JSDocSignature, context: Context<Data>): void;
  "JSDocSignature:exit"?(node: JSDocSignature, context: Context<Data>): void;
  JSDocTemplateTag?(node: JSDocTemplateTag, context: Context<Data>): void;
  "JSDocTemplateTag:exit"?(node: JSDocTemplateTag, context: Context<Data>): void;
  JSDocText?(node: JSDocText, context: Context<Data>): void;
  "JSDocText:exit"?(node: JSDocText, context: Context<Data>): void;
  JSDocTypeExpression?(node: JSDocTypeExpression, context: Context<Data>): void;
  "JSDocTypeExpression:exit"?(node: JSDocTypeExpression, context: Context<Data>): void;
  JSDocTypeLiteral?(node: JSDocTypeLiteral, context: Context<Data>): void;
  "JSDocTypeLiteral:exit"?(node: JSDocTypeLiteral, context: Context<Data>): void;
  JSDocUnknownType?(node: JSDocUnknownType, context: Context<Data>): void;
  "JSDocUnknownType:exit"?(node: JSDocUnknownType, context: Context<Data>): void;
  JSDocVariadicType?(node: JSDocVariadicType, context: Context<Data>): void;
  "JSDocVariadicType:exit"?(node: JSDocVariadicType, context: Context<Data>): void;
  JsxAttribute?(node: JsxAttribute, context: Context<Data>): void;
  "JsxAttribute:exit"?(node: JsxAttribute, context: Context<Data>): void;
  JsxAttributes?(node: JsxAttributes, context: Context<Data>): void;
  "JsxAttributes:exit"?(node: JsxAttributes, context: Context<Data>): void;
  JsxClosingElement?(node: JsxClosingElement, context: Context<Data>): void;
  "JsxClosingElement:exit"?(node: JsxClosingElement, context: Context<Data>): void;
  JsxClosingFragment?(node: JsxClosingFragment, context: Context<Data>): void;
  "JsxClosingFragment:exit"?(node: JsxClosingFragment, context: Context<Data>): void;
  JsxElement?(node: JsxElement, context: Context<Data>): void;
  "JsxElement:exit"?(node: JsxElement, context: Context<Data>): void;
  JsxExpression?(node: JsxExpression, context: Context<Data>): void;
  "JsxExpression:exit"?(node: JsxExpression, context: Context<Data>): void;
  JsxFragment?(node: JsxFragment, context: Context<Data>): void;
  "JsxFragment:exit"?(node: JsxFragment, context: Context<Data>): void;
  JsxNamespacedName?(node: JsxNamespacedName, context: Context<Data>): void;
  "JsxNamespacedName:exit"?(node: JsxNamespacedName, context: Context<Data>): void;
  JsxOpeningElement?(node: JsxOpeningElement, context: Context<Data>): void;
  "JsxOpeningElement:exit"?(node: JsxOpeningElement, context: Context<Data>): void;
  JsxOpeningFragment?(node: JsxOpeningFragment, context: Context<Data>): void;
  "JsxOpeningFragment:exit"?(node: JsxOpeningFragment, context: Context<Data>): void;
  JsxSelfClosingElement?(node: JsxSelfClosingElement, context: Context<Data>): void;
  "JsxSelfClosingElement:exit"?(node: JsxSelfClosingElement, context: Context<Data>): void;
  JsxSpreadAttribute?(node: JsxSpreadAttribute, context: Context<Data>): void;
  "JsxSpreadAttribute:exit"?(node: JsxSpreadAttribute, context: Context<Data>): void;
  JsxText?(node: JsxText, context: Context<Data>): void;
  "JsxText:exit"?(node: JsxText, context: Context<Data>): void;
  LabeledStatement?(node: LabeledStatement, context: Context<Data>): void;
  "LabeledStatement:exit"?(node: LabeledStatement, context: Context<Data>): void;
  LiteralType?(node: LiteralTypeNode, context: Context<Data>): void;
  "LiteralType:exit"?(node: LiteralTypeNode, context: Context<Data>): void;
  MappedType?(node: MappedTypeNode, context: Context<Data>): void;
  "MappedType:exit"?(node: MappedTypeNode, context: Context<Data>): void;
  MetaProperty?(node: MetaProperty, context: Context<Data>): void;
  "MetaProperty:exit"?(node: MetaProperty, context: Context<Data>): void;
  MethodDeclaration?(node: MethodDeclaration, context: Context<Data>): void;
  "MethodDeclaration:exit"?(node: MethodDeclaration, context: Context<Data>): void;
  MethodSignature?(node: MethodSignature, context: Context<Data>): void;
  "MethodSignature:exit"?(node: MethodSignature, context: Context<Data>): void;
  MissingDeclaration?(node: MissingDeclaration, context: Context<Data>): void;
  "MissingDeclaration:exit"?(node: MissingDeclaration, context: Context<Data>): void;
  ModuleBlock?(node: ModuleBlock, context: Context<Data>): void;
  "ModuleBlock:exit"?(node: ModuleBlock, context: Context<Data>): void;
  ModuleDeclaration?(node: ModuleDeclaration, context: Context<Data>): void;
  "ModuleDeclaration:exit"?(node: ModuleDeclaration, context: Context<Data>): void;
  NamedExports?(node: NamedExports, context: Context<Data>): void;
  "NamedExports:exit"?(node: NamedExports, context: Context<Data>): void;
  NamedImports?(node: NamedImports, context: Context<Data>): void;
  "NamedImports:exit"?(node: NamedImports, context: Context<Data>): void;
  NamedTupleMember?(node: NamedTupleMember, context: Context<Data>): void;
  "NamedTupleMember:exit"?(node: NamedTupleMember, context: Context<Data>): void;
  NamespaceExport?(node: NamespaceExport, context: Context<Data>): void;
  "NamespaceExport:exit"?(node: NamespaceExport, context: Context<Data>): void;
  NamespaceExportDeclaration?(node: NamespaceExportDeclaration, context: Context<Data>): void;
  "NamespaceExportDeclaration:exit"?(node: NamespaceExportDeclaration, context: Context<Data>): void;
  NamespaceImport?(node: NamespaceImport, context: Context<Data>): void;
  "NamespaceImport:exit"?(node: NamespaceImport, context: Context<Data>): void;
  NeverKeyword?(node: NeverKeyword, context: Context<Data>): void;
  "NeverKeyword:exit"?(node: NeverKeyword, context: Context<Data>): void;
  NewExpression?(node: NewExpression, context: Context<Data>): void;
  "NewExpression:exit"?(node: NewExpression, context: Context<Data>): void;
  NoSubstitutionTemplateLiteral?(node: NoSubstitutionTemplateLiteral, context: Context<Data>): void;
  "NoSubstitutionTemplateLiteral:exit"?(node: NoSubstitutionTemplateLiteral, context: Context<Data>): void;
  ...
  "NumberKeyword:exit"?(node: NumberKeyword, context: Context<Data>): void;
  NumericLiteral?(node: NumericLiteral, context: Context<Data>): void;
  "NumericLiteral:exit"?(node: NumericLiteral, context: Context<Data>): void;
  ObjectBindingPattern?(node: ObjectBindingPattern, context: Context<Data>): void;
  "ObjectBindingPattern:exit"?(node: ObjectBindingPattern, context: Context<Data>): void;
  ObjectKeyword?(node: ObjectKeyword, context: Context<Data>): void;
  "ObjectKeyword:exit"?(node: ObjectKeyword, context: Context<Data>): void;
  ObjectLiteralExpression?(node: ObjectLiteralExpression, context: Context<Data>): void;
  "ObjectLiteralExpression:exit"?(node: ObjectLiteralExpression, context: Context<Data>): void;
  OmittedExpression?(node: OmittedExpression, context: Context<Data>): void;
  "OmittedExpression:exit"?(node: OmittedExpression, context: Context<Data>): void;
  OptionalType?(node: OptionalTypeNode, context: Context<Data>): void;
  "OptionalType:exit"?(node: OptionalTypeNode, context: Context<Data>): void;
  Parameter?(node: ParameterDeclaration, context: Context<Data>): void;
  "Parameter:exit"?(node: ParameterDeclaration, context: Context<Data>): void;
  ParenthesizedExpression?(node: ParenthesizedExpression, context: Context<Data>): void;
  "ParenthesizedExpression:exit"?(node: ParenthesizedExpression, context: Context<Data>): void;
  ParenthesizedType?(node: ParenthesizedTypeNode, context: Context<Data>): void;
  "ParenthesizedType:exit"?(node: ParenthesizedTypeNode, context: Context<Data>): void;
  PartiallyEmittedExpression?(node: PartiallyEmittedExpression, context: Context<Data>): void;
  "PartiallyEmittedExpression:exit"?(node: PartiallyEmittedExpression, context: Context<Data>): void;
  PostfixUnaryExpression?(node: PostfixUnaryExpression, context: Context<Data>): void;
  "PostfixUnaryExpression:exit"?(node: PostfixUnaryExpression, context: Context<Data>): void;
  PrefixUnaryExpression?(node: PrefixUnaryExpression, context: Context<Data>): void;
  "PrefixUnaryExpression:exit"?(node: PrefixUnaryExpression, context: Context<Data>): void;
  PrivateIdentifier?(node: PrivateIdentifier, context: Context<Data>): void;
  "PrivateIdentifier:exit"?(node: PrivateIdentifier, context: Context<Data>): void;
  PropertyAccessExpression?(node: PropertyAccessExpression, context: Context<Data>): void;
  "PropertyAccessExpression:exit"?(node: PropertyAccessExpression, context: Context<Data>): void;
  PropertyAssignment?(node: PropertyAssignment, context: Context<Data>): void;
  "PropertyAssignment:exit"?(node: PropertyAssignment, context: Context<Data>): void;
  PropertyDeclaration?(node: PropertyDeclaration, context: Context<Data>): void;
  "PropertyDeclaration:exit"?(node: PropertyDeclaration, context: Context<Data>): void;
  PropertySignature?(node: PropertySignature, context: Context<Data>): void;
  "PropertySignature:exit"?(node: PropertySignature, context: Context<Data>): void;
  QualifiedName?(node: QualifiedName, context: Context<Data>): void;
  "QualifiedName:exit"?(node: QualifiedName, context: Context<Data>): void;
  RegularExpressionLiteral?(node: RegularExpressionLiteral, context: Context<Data>): void;
  "RegularExpressionLiteral:exit"?(node: RegularExpressionLiteral, context: Context<Data>): void;
  RestType?(node: RestTypeNode, context: Context<Data>): void;
  "RestType:exit"?(node: RestTypeNode, context: Context<Data>): void;
  ReturnStatement?(node: ReturnStatement, context: Context<Data>): void;
  "ReturnStatement:exit"?(node: ReturnStatement, context: Context<Data>): void;
  SatisfiesExpression?(node: SatisfiesExpression, context: Context<Data>): void;
  "SatisfiesExpression:exit"?(node: SatisfiesExpression, context: Context<Data>): void;
  SemicolonClassElement?(node: SemicolonClassElement, context: Context<Data>): void;
  "SemicolonClassElement:exit"?(node: SemicolonClassElement, context: Context<Data>): void;
  SetAccessor?(node: SetAccessorDeclaration, context: Context<Data>): void;
  "SetAccessor:exit"?(node: SetAccessorDeclaration, context: Context<Data>): void;
  ShorthandPropertyAssignment?(node: ShorthandPropertyAssignment, context: Context<Data>): void;
  "ShorthandPropertyAssignment:exit"?(node: ShorthandPropertyAssignment, context: Context<Data>): void;
  SourceFile?(node: SourceFile, context: Context<Data>): void;
  "SourceFile:exit"?(node: SourceFile, context: Context<Data>): void;
  SpreadAssignment?(node: SpreadAssignment, context: Context<Data>): void;
  "SpreadAssignment:exit"?(node: SpreadAssignment, context: Context<Data>): void;
  SpreadElement?(node: SpreadElement, context: Context<Data>): void;
  "SpreadElement:exit"?(node: SpreadElement, context: Context<Data>): void;
  StringKeyword?(node: StringKeyword, context: Context<Data>): void;
  "StringKeyword:exit"?(node: StringKeyword, context: Context<Data>): void;
  StringLiteral?(node: StringLiteral, context: Context<Data>): void;
  "StringLiteral:exit"?(node: StringLiteral, context: Context<Data>): void;
  SuperKeyword?(node: SuperExpression, context: Context<Data>): void;
  "SuperKeyword:exit"?(node: SuperExpression, context: Context<Data>): void;
  SwitchStatement?(node: SwitchStatement, context: Context<Data>): void;
  "SwitchStatement:exit"?(node: SwitchStatement, context: Context<Data>): void;
  SymbolKeyword?(node: SymbolKeyword, context: Context<Data>): void;
  "SymbolKeyword:exit"?(node: SymbolKeyword, context: Context<Data>): void;
  SyntheticExpression?(node: SyntheticExpression, context: Context<Data>): void;
  "SyntheticExpression:exit"?(node: SyntheticExpression, context: Context<Data>): void;
  TaggedTemplateExpression?(node: TaggedTemplateExpression, context: Context<Data>): void;
  "TaggedTemplateExpression:exit"?(node: TaggedTemplateExpression, context: Context<Data>): void;
  TemplateExpression?(node: TemplateExpression, context: Context<Data>): void;
  "TemplateExpression:exit"?(node: TemplateExpression, context: Context<Data>): void;
  TemplateHead?(node: TemplateHead, context: Context<Data>): void;
  "TemplateHead:exit"?(node: TemplateHead, context: Context<Data>): void;
  TemplateLiteralType?(node: TemplateLiteralTypeNode, context: Context<Data>): void;
  "TemplateLiteralType:exit"?(node: TemplateLiteralTypeNode, context: Context<Data>): void;
  TemplateLiteralTypeSpan?(node: TemplateLiteralTypeSpan, context: Context<Data>): void;
  "TemplateLiteralTypeSpan:exit"?(node: TemplateLiteralTypeSpan, context: Context<Data>): void;
  TemplateMiddle?(node: TemplateMiddle, context: Context<Data>): void;
  "TemplateMiddle:exit"?(node: TemplateMiddle, context: Context<Data>): void;
  TemplateSpan?(node: TemplateSpan, context: Context<Data>): void;
  "TemplateSpan:exit"?(node: TemplateSpan, context: Context<Data>): void;
  TemplateTail?(node: TemplateTail, context: Context<Data>): void;
  "TemplateTail:exit"?(node: TemplateTail, context: Context<Data>): void;
  ThisKeyword?(node: ThisExpression, context: Context<Data>): void;
  "ThisKeyword:exit"?(node: ThisExpression, context: Context<Data>): void;
  ThisType?(node: ThisTypeNode, context: Context<Data>): void;
  "ThisType:exit"?(node: ThisTypeNode, context: Context<Data>): void;
  ThrowStatement?(node: ThrowStatement, context: Context<Data>): void;
  "ThrowStatement:exit"?(node: ThrowStatement, context: Context<Data>): void;
  TrueKeyword?(node: TrueLiteral, context: Context<Data>): void;
  "TrueKeyword:exit"?(node: TrueLiteral, context: Context<Data>): void;
  TryStatement?(node: TryStatement, context: Context<Data>): void;
  "TryStatement:exit"?(node: TryStatement, context: Context<Data>): void;
  TupleType?(node: TupleTypeNode, context: Context<Data>): void;
  "TupleType:exit"?(node: TupleTypeNode, context: Context<Data>): void;
  TypeAliasDeclaration?(node: TypeAliasDeclaration, context: Context<Data>): void;
  "TypeAliasDeclaration:exit"?(node: TypeAliasDeclaration, context: Context<Data>): void;
  TypeAssertionExpression?(node: TypeAssertion, context: Context<Data>): void;
  "TypeAssertionExpression:exit"?(node: TypeAssertion, context: Context<Data>): void;
  TypeLiteral?(node: TypeLiteralNode, context: Context<Data>): void;
  "TypeLiteral:exit"?(node: TypeLiteralNode, context: Context<Data>): void;
  TypeOfExpression?(node: TypeOfExpression, context: Context<Data>): void;
  "TypeOfExpression:exit"?(node: TypeOfExpression, context: Context<Data>): void;
  TypeOperator?(node: TypeOperatorNode, context: Context<Data>): void;
  "TypeOperator:exit"?(node: TypeOperatorNode, context: Context<Data>): void;
  TypeParameter?(node: TypeParameterDeclaration, context: Context<Data>): void;
  "TypeParameter:exit"?(node: TypeParameterDeclaration, context: Context<Data>): void;
  TypePredicate?(node: TypePredicateNode, context: Context<Data>): void;
  "TypePredicate:exit"?(node: TypePredicateNode, context: Context<Data>): void;
  TypeQuery?(node: TypeQueryNode, context: Context<Data>): void;
  "TypeQuery:exit"?(node: TypeQueryNode, context: Context<Data>): void;
  TypeReference?(node: TypeReferenceNode, context: Context<Data>): void;
  "TypeReference:exit"?(node: TypeReferenceNode, context: Context<Data>): void;
  UndefinedKeyword?(node: UndefinedKeyword, context: Context<Data>): void;
  "UndefinedKeyword:exit"?(node: UndefinedKeyword, context: Context<Data>): void;
  UnionType?(node: UnionTypeNode, context: Context<Data>): void;
  "UnionType:exit"?(node: UnionTypeNode, context: Context<Data>): void;
  UnknownKeyword?(node: UnknownKeyword, context: Context<Data>): void;
  "UnknownKeyword:exit"?(node: UnknownKeyword, context: Context<Data>): void;
  VariableDeclaration?(node: VariableDeclaration, context: Context<Data>): void;
  "VariableDeclaration:exit"?(node: VariableDeclaration, context: Context<Data>): void;
  VariableDeclarationList?(node: VariableDeclarationList, context: Context<Data>): void;
  "VariableDeclarationList:exit"?(node: VariableDeclarationList, context: Context<Data>): void;
  VariableStatement?(node: VariableStatement, context: Context<Data>): void;
  "VariableStatement:exit"?(node: VariableStatement, context: Context<Data>): void;
  VoidExpression?(node: VoidExpression, context: Context<Data>): void;
  "VoidExpression:exit"?(node: VoidExpression, context: Context<Data>): void;
  VoidKeyword?(node: VoidKeyword, context: Context<Data>): void;
  "VoidKeyword:exit"?(node: VoidKeyword, context: Context<Data>): void;
  WhileStatement?(node: WhileStatement, context: Context<Data>): void;
  "WhileStatement:exit"?(node: WhileStatement, context: Context<Data>): void;
  WithStatement?(node: WithStatement, context: Context<Data>): void;
  "WithStatement:exit"?(node: WithStatement, context: Context<Data>): void;
  YieldExpression?(node: YieldExpression, context: Context<Data>): void;
  "YieldExpression:exit"?(node: YieldExpression, context: Context<Data>): void;
};
