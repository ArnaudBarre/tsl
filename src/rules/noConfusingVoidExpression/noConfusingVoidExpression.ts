...
export function noConfusingVoidExpression(
          ...
          return [
            {
              ...
              changes: [{ node: invalidAncestor, newText: newReturnStmtText }],
            },
          ];
        },
      });
  ...
  function isVoidReturningFunctionNode(
    ...
    if (functionNode.type) {
      const returnType = context.checker.getTypeFromTypeNode(functionNode.type);
