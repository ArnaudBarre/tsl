...
export type Visitor<Data = undefined> = {
  ...
  ArrayTypeNode?(node: ArrayTypeNode, context: Context<Data>): void;
  ...
  CallSignatureDeclaration?(node: CallSignatureDeclaration, context: Context<Data>): void;
  ...
  ConditionalTypeNode?(node: ConditionalTypeNode, context: Context<Data>): void;
  ConstructSignatureDeclaration?(node: ConstructSignatureDeclaration, context: Context<Data>): void;
  ConstructorDeclaration?(node: ConstructorDeclaration, context: Context<Data>): void;
  ConstructorTypeNode?(node: ConstructorTypeNode, context: Context<Data>): void;
  ...
  FalseLiteral?(node: FalseLiteral, context: Context<Data>): void;
  ...
  FunctionTypeNode?(node: FunctionTypeNode, context: Context<Data>): void;
  GetAccessorDeclaration?(node: GetAccessorDeclaration, context: Context<Data>): void;
  ...
  ImportExpression?(node: ImportExpression, context: Context<Data>): void;
  ImportSpecifier?(node: ImportSpecifier, context: Context<Data>): void;
  ImportTypeNode?(node: ImportTypeNode, context: Context<Data>): void;
  IndexSignatureDeclaration?(node: IndexSignatureDeclaration, context: Context<Data>): void;
  IndexedAccessTypeNode?(node: IndexedAccessTypeNode, context: Context<Data>): void;
  InferTypeNode?(node: InferTypeNode, context: Context<Data>): void;
  InterfaceDeclaration?(node: InterfaceDeclaration, context: Context<Data>): void;
  IntersectionTypeNode?(node: IntersectionTypeNode, context: Context<Data>): void;
  ...
  LiteralTypeNode?(node: LiteralTypeNode, context: Context<Data>): void;
  MappedTypeNode?(node: MappedTypeNode, context: Context<Data>): void;
  ...
  NullLiteral?(node: NullLiteral, context: Context<Data>): void;
  ...
  OptionalTypeNode?(node: OptionalTypeNode, context: Context<Data>): void;
  ParameterDeclaration?(node: ParameterDeclaration, context: Context<Data>): void;
  ParenthesizedExpression?(node: ParenthesizedExpression, context: Context<Data>): void;
  ParenthesizedTypeNode?(node: ParenthesizedTypeNode, context: Context<Data>): void;
  ...
  RestTypeNode?(node: RestTypeNode, context: Context<Data>): void;
  ...
  SetAccessorDeclaration?(node: SetAccessorDeclaration, context: Context<Data>): void;
  ...
  SuperExpression?(node: SuperExpression, context: Context<Data>): void;
  ...
  TemplateLiteralTypeNode?(node: TemplateLiteralTypeNode, context: Context<Data>): void;
  ...
  ThisExpression?(node: ThisExpression, context: Context<Data>): void;
  ThisTypeNode?(node: ThisTypeNode, context: Context<Data>): void;
  ThrowStatement?(node: ThrowStatement, context: Context<Data>): void;
  TrueLiteral?(node: TrueLiteral, context: Context<Data>): void;
  TryStatement?(node: TryStatement, context: Context<Data>): void;
  TupleTypeNode?(node: TupleTypeNode, context: Context<Data>): void;
  TypeAliasDeclaration?(node: TypeAliasDeclaration, context: Context<Data>): void;
  TypeAssertion?(node: TypeAssertion, context: Context<Data>): void;
  TypeLiteralNode?(node: TypeLiteralNode, context: Context<Data>): void;
  TypeOfExpression?(node: TypeOfExpression, context: Context<Data>): void;
  TypeOperatorNode?(node: TypeOperatorNode, context: Context<Data>): void;
  TypeParameterDeclaration?(node: TypeParameterDeclaration, context: Context<Data>): void;
  TypePredicateNode?(node: TypePredicateNode, context: Context<Data>): void;
  TypeQueryNode?(node: TypeQueryNode, context: Context<Data>): void;
  TypeReferenceNode?(node: TypeReferenceNode, context: Context<Data>): void;
  UnionTypeNode?(node: UnionTypeNode, context: Context<Data>): void;
